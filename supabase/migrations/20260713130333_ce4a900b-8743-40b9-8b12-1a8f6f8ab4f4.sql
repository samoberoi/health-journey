...
BEGIN
  ...
  WHILE _week_start + 6 <= _today LOOP
    ...
    WHERE ml.level_number = _current_level
    ...
    INSERT INTO public.user_movement_weekly (
      ...
      _user_id, _week_start, _current_level, _target,
...
CREATE OR REPLACE FUNCTION public.refresh_gamification_for_user(_user_id uuid, _day date DEFAULT NULL::date)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO 'public'
...
BEGIN
  ...
  PERFORM public.recompute_movement_progress_for_user(_user_id, _d);
