  ...
  return (
    <div className="phone-container min-h-dvh flex flex-col px-5 pt-14 mobile-bottom-safe bg-background">
      ...
      <div className="ob-bottom flex gap-3 shrink-0">
        ...
        <button onClick={skip} className="ob-cta flex-1 whitespace-nowrap" style={{ background: "transparent", color: "var(--bbdo-ink)", border: "1px solid var(--bbdo-line, rgba(0,0,0,0.12))", boxShadow: "none" }}>
          Skip
        </button>

        <motion.button onClick={goNext} disabled={!canProceed} className="ob-cta flex-1 disabled:opacity-40 whitespace-nowrap" style={{ background: "var(--bbdo-blue)", color: "#fff" }} whileTap={{ scale: 0.98 }}>
